...
/**
 * Exercise:         22
 * Description:      Use a type tag along with reflection to create a method that uses the
...
public class Exercise22<T> {
    ...
    public static void main(String[] args) {
        Exercise22<Building> ctcb = new Exercise22<Building>(Building.class);
        Exercise22<House> ctch = new Exercise22<House>(House.class);
        try {
